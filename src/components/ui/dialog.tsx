  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // max-h/overflow are part of the BASE, not a per-dialog override.
          // Every one of the app's ten dialogs passed `max-h-[85vh]
          // overflow-y-auto` — a default wearing an override's clothes, and one
          // a new dialog could silently be written without. A dialog that
          // genuinely wants a different ceiling still passes one: `cn` is
          // twMerge, so a `max-h-*` in `className` replaces this rather than
          // fighting it.
