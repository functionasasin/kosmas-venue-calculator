...
insert into items (name, category, role_key, supplier, poe_watts, rack_u, notes, print_note) values
  ...
  ('Dahua PFA130-E Junction Box', 'camera', 'junction_box', 'Drextech', null, 0, 'Colour-match the camera.', null),
  ('EmpireTech / Dahua IPC-HDW5459T-ZE-IL (Security Camera)', 'camera', 'security_camera', 'Drextech', 17.5, 0, 'Autonomous+ only.', null),
  ('Dahua PFA130-E Junction Box (Security)', 'camera', 'security_junction_box', 'Drextech', null, 0, null, null),
  ...
  ('HIDEit ATV4K 3G Mount', 'court', 'apple_tv_mount', null, null, 0, null, 'ATV4K 3G SKU — the older ATV4K fits 1st/2nd gen only.'),
  ('HDMI Cable', 'court', 'hdmi_cable', null, null, 0, null, null),
  ('Samsung 65" TV (U8000F)', 'court', 'display', null, null, 0, null, null),
  ('Tilt Mount', 'court', 'tilt_mount', null, null, 0, null, null),
  ...
  ('C14-to-Universal Adapter Plug (10A 250V)', 'power', 'c14_adapter', 'Lazada', null, 0, null, null),
